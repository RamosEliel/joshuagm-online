...
export default function NuevoGuiaMayorPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!response.ok) {
        ...
        throw new Error(data.error || 'Error al crear el guía mayor');
      }
  ...
  return (
    <RequireRole allowedRoles={['ADMINISTRADOR', 'TESORERO', 'GESTOR_BIENES']}>
      <div className={styles.page}>
        <div className={styles.pageHeader}>
          <div>
            <h1 className={styles.pageTitle}>Nuevo Guia Mayor</h1>
            <p className={styles.pageSubtitle}>Registro de un nuevo guia mayor en el sistema</p>
          </div>
        </div>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className={styles.formActions}>
              ...
              <button
                ...
                disabled={loading}
              >
                {loading ? 'Guardando...' : 'Guardar Guia Mayor'}
              </button>
            </div>
          </form>
        </div>
